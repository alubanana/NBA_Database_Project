...
(
	...
	time_clock numeric(8,2) check (time_clock>=0 and time_clock<=24) , /* shots clock should be integer between 0 to 24*/
	shot_result boolean,
	quarter numeric(1,0) check (quarter in (1,2,3,4,6,7,8,9)),/* there are only 4 quarters*/
	primary key (shot_id)
	);
